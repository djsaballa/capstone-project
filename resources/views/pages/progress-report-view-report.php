                        ...
                        <div class="intro-y box lg:mt-5">
                            <table class="table">
                                ...
                                <tbody>
                                        <tr>
                                            <th scope="row">
                                            <div class="flex items-center justify-center ">  12/12/2020 </div>
                                            </th>
                                            <td><div class="flex items-center justify-center "> 09123456789 </div></td>
                                            <td><div class="flex items-center justify-center "> lorem ipsum </div></td>
                                            <td><div class="flex items-center justify-center ">  lorem ipsum </div></td>
                                            <td><div class="flex items-center justify-center ">  attachment  </div></td>
                                        </tr>                                  
                                </tbody>
                            </table>
                        </div>
