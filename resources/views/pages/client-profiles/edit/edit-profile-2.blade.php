                    ...
                    <div class="px-5 sm:px-20 mt-10 pt-10 border-t border-slate-200/60 dark:border-darkmode-400">
                        ...
                        <div class="grid grid-cols-20 gap-4 gap-y-5 mt-5">
                            @foreach ($family_compositions as $family_composition)
                                <div class="col-span-2 2xl:col-span-1">
                                    ...
                                    <input id="input-wizard-1" type="text" class="form-control" placeholder="Full Name"
                                        value="{{ $family_composition->getFullName($family_composition->id) }}">
                                </div>
                                <div class="col-span-2 2xl:col-span-1">
                                    ...
                                    <select id="update-profile-form-3" data-search="true"
                                        ...
                                        <option value="{{ $family_composition->relationship }}" selected="true">
                                            {{ $family_composition->relationship }}</option>
                                ...
                                <div class="col-span-2 2xl:col-span-1">
                                    ...
                                    <select id="update-profile-form-3" data-search="true"
                                        class="tom-select w-full tomselected" tabindex="-1" hidden="hidden">
                                        <option value="{{ $family_composition->educational_attainment }}" selected="true">
                                            {{ $family_composition->educational_attainment }}</option>
                                ...
                                <div class="col-span-2 2xl:col-span-1">
                                    ...
                                    <input id="input-wizard-4" type="text" class="form-control" placeholder="Occupation"
                            ...
                            <div class="intro-y col-span-12 flex items-center justify-center sm:justify-end mt-5">
                                <a class="btn btn-secondary w-24"
