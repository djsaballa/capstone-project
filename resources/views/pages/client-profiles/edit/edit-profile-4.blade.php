                ...
                <div class="grid grid-cols-12 gap-4 gap-y-5 mt-5">
                    ...
                    <div class="grid grid-cols-12 gap-4 gap-y-5 mt-5">
                        ...
                        <div class="intro-y col-span-12 flex items-center justify-center sm:justify-end mt-5 mb-5">
                            <a class="btn btn-secondary w-24 ml-2" href="{{ route('edit_profile_3', [$employee_info->id, $client_profile_info->id]) }}">Previous</a>
                            <a class="btn btn-primary w-24 ml-2" href="{{ route('edit_profile_5', [$employee_info->id, $client_profile_info->id]) }}">Next</a>
                        </div>
                    </div>
                </div>
                <!-- END: Wizard Layout -->
