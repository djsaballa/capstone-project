                    ...
                    <div class="grid grid-cols-12 gap-x-5">
                        <div class="col-span-6 2xl:col-span-3">
                            <div class="mt-3">
                                ...
                                <input id="update-profile-form-1" type="text" class="form-control" placeholder="Name"
                                    value="Jared Galzote" disabled>
                            </div>
                            <div class="mt-3">
                                ...
                                <input id="update-profile-form-4" type="text" class="form-control"
                                    placeholder="Input text" value="09123456789" disabled>
                            </div>
                        ...
                        <div class="col-span-6 2xl:col-span-3">
                            <div class="mt-3">
                                ...
                                <input id="update-profile-form-1" type="text" class="form-control"
                                    placeholder="username@gmail.com" value="username@gmail.com" disabled>
                            </div>
                            <div class="mt-3">
                        ...
                        <div class="col-span-6 2xl:col-span-3">
                            <div class="mt-3">
                                ...
                                <input id="update-profile-form-1" type="text" class="form-control" placeholder="Name"
                                    value="Division 1" disabled>
                            </div>
                            <div class="mt-3">
                                <label for="update-profile-form-3-tomselected" class="form-label"
                                    id="update-profile-form-3-ts-label">District</label>
                                <input id="update-profile-form-1" type="text" class="form-control" placeholder="Name"
                                    value="District 1" disabled>
                            </div>
