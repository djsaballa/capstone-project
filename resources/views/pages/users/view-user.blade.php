        ...
        <div class="flex items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400">
            ...
            @if ($user_info->role_id == 10 || $user_info->role_id == 11)
                <div class="intro-y col-span-12 flex items-center justify-center sm:justify-end mt-5">
                    <a href="{{ route('edit_user', [$user_info->id, $employee_info->id]) }}"
                        class="btn btn-primary w-24 ml-2">Edit</a>
                </div>
            @endif
        </div>
        <div class="p-5">
                    ...
                    <div class="grid grid-cols-12 gap-x-5">
                        <div class="col-span-6 2xl:col-span-3">
                            ...
                            <div class="mt-3">
                                ...
                                <input id="update-profile-form-4" type="text" class="form-control" placeholder=""
                                    value="{{ $employee_info->contact_number }}" disabled>
                            </div>
                        </div>
                        <div class="col-span-6 2xl:col-span-3">
                            <div class="mt-3">
                        ...
                        <div class="w-52 mx-auto xl:mr-0 xl:ml-6">
                            <div class="mt-3">
                                ...
                                <input id="update-profile-form-4" type="text" class="form-control" placeholder=""
                                    value="{{ $employee_info->username }}" disabled>
                            </div>
                            <div
                        ...
                        @if ($previous_route == 'view_inbox')
                            <div class="intro-y col-span-12 flex items-center justify-center sm:justify-end mt-5">
                                <a href="{{ route('inbox', [$user_info->id]) }}"
                                    class="btn btn-primary w-24 ml-2">Return</a>
                            </div>
                        @else
                            <div class="intro-y col-span-12 flex items-center justify-center sm:justify-end mt-5">
                                <a href="{{ route($previous_route, [$user_info->id]) }}"
                                    class="btn btn-primary w-24 ml-2">Return</a>
                            </div>
                        @endif
                    </div>
